...
public class TennisGameTest {
    ...
    public void checkAllScores() {
        int highestScore = Math.max(this.playerFirstScore, this.player2Score);
        int m_score1 = 0;
        int m_score2 = 0;
        for (int i = 0; i < highestScore; i++) {
            if (i < this.playerFirstScore)
                m_score1 += 1;
